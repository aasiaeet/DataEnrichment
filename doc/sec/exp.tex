...
Table \ref{table:1} summarizes a highlight of our findings which shows lung and blood parameters' supports are correctly capturing a meaningful set of genes.% while the shared parameter has mixed set of genes. 
%{\small 
