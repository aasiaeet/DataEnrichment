...
%\newcommand{\Th}[1]{Theorem~\quad\quad#1}} % when starting a sentence
%\renewcommand{\th}[1]{Theorem~\quad\quad#1}}
%\newcommand{\ths}[2]{Theorems~\quad\quad#1} and~\quad\quad#2}}
%\newcommand{\thst}[2]{Theorems~\quad\quad#1}-\quad\quad#2}}
%\newcommand{\lem}[1]{Lemma~\quad\quad#1}}
%\newcommand{\prop}[1]{Proposition~\quad\quad#1}}
%\newcommand{\defin}[1]{Definition~\quad\quad#1}}
%\newcommand{\eq}[1]{equation~(\quad\quad#1})}
%\newcommand{\ineq}[1]{inequality~(\quad\quad#1})}
%\newcommand{\Ineq}[1]{Inequality~(\quad\quad#1})}
%\newcommand{\ineqs}[2]{inequalities~(\quad\quad#1}) and~(\quad\quad#2})}
%\newcommand{\Eq}[1]{Equation~(\quad\quad#1})}
%\newcommand{\eqs}[2]{equations~(\quad\quad#1}) and~(\quad\quad#2})}
%\newcommand{\eqss}[3]{equations~(\quad\quad#1}), (\quad\quad#2}) and~(\quad\quad#3})}
%\newcommand{\eqst}[2]{equations~(\quad\quad#1})-(\quad\quad#2})}
