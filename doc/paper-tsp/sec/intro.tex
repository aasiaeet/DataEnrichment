...
In spite of the recent surge in applying data sharing framework to different domains, limited advances have been made in
...
\textbf{Sub-Gaussian random variable and vector:}
...
%	\item The general bound of \ref{eq:errorsum} entails the following bounds for specific parameters:
%	\be
%	\nr
...
We delineate our geometrically convergent algorithm, \dc{} in Section \ref{sec:opt} and finally supplement our work with experiments on synthetic data in Section \ref{sec:expds}.% and \ref{realexp}.
